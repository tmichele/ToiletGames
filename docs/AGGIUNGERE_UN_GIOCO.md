...
Attenzione a una conseguenza: si riparte sempre dal livello più alto raggiunto,
quindi una partita può **cominciare da un livello qualsiasi** e `start(level)` va
scritto in modo che il livello 10 funzioni anche senza aver giocato i nove
precedenti. Se il
