...
| 🏓 **Pong CPU** | Uno contro uno con avversario simulato | La CPU è più rapida e sbaglia meno la mira, pallina più veloce, racchetta più corta |
| 🧠 **Memoria** | Ripeti la sequenza luminosa | Da 4 a 9 riquadri, sequenze più lunghe, riproduzione più rapida, tempo limite per tocco |
| 🧱 **Mattoni** | Breakout | Più file, mattoni corazzati dal livello 4, pallina più veloce; le vite valgono per tutta la partita |
...
Apre la pagina da `file://` in Chromium headless e controlla elenco dei giochi,
partite reali dei quattro titoli, classifiche, avanzamento di livello, pausa,
deep link e assenza di errori in console.
